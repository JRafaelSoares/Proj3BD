...
for i in range(1, numVezes*3):
	f.write("'Entidade" + str(i) + "'" + (end if (i == numVezes*3 - 1) else between))

f.write("\n");

f.write(isrt + "Meio(numMeio, nomeMeio, nomeEntidade)" + value)
for i in range(1, numVezes*3):
	f.write(str(i) + ", 'veiculo" + str(i) + "', '" + "Entidade" + str(i) + "'" + (end if (i == numVezes*3 - 1) else between))
...
f.write(isrt + "Acciona(numMeio, nomeEntidade, numProcessoSocorro)" + value)
for i in range(numVezes, numVezes*2 - 1):
	f.write(str(i) + ", 'Entidade" + str(i) + "', " + str(i - numVezes + 1) + (end if (i == numVezes*2 - 2) else between))
f.write("\n");

f.write(isrt + "Acciona(numMeio, nomeEntidade, numProcessoSocorro)" + value)
for i in range(numVezes*2 - 1, numVezes*3 - 2):
	f.write(str(i) + ", 'Entidade" + str(i) + "', " + str(i - 2*numVezes + 2) + (end if (i == numVezes*3 - 3) else between))
f.write("\n");
...
f.write(isrt + "MeioApoio(numMeio, nomeEntidade)" + value)
for i in range(numVezes, numVezes*2 - 1):
	f.write(str(i) + ", 'Entidade" + str(i) + "'" + (end if (i == numVezes*2 - 2) else between))

f.write("\n");

f.write(isrt + "MeioSocorro(numMeio, nomeEntidade)" + value)
for i in range(numVezes*2 - 1, numVezes*3 - 2):
	f.write(str(i) + ", 'Entidade" + str(i) + "'" + (end if (i == numVezes*3 - 3) else between))
...
for i in range(numVezes, numVezes*2 - 1):
	f.write(str(i) + ", 'Entidade" + str(i) + "', " + str(i) + ", " + str(i - numVezes + 1) + (end if (i == numVezes*2 - 2) else between))
